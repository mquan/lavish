...
@gray-darker:            #{@colors[6] || 'lighten(#000, 13.5%)'};
@gray-dark:              #{@colors[5] || 'lighten(#000, 20%)'};
@gray:                   #{@colors[3] || 'lighten(#000, 33.5%)'};
@gray-light:             #{@colors[2] || 'lighten(#000, 60%)'};
@gray-lighter:           #{@colors[1] || 'lighten(#000, 93.5%)'};

// Brand colors
// -------------------------

@brand-primary:         #{@colors[4] || '#428bca'};
...
@table-border-color:                 #{@colors[5] || '#ddd'}; // table and cell border
